...
window.importElementToCanvas = function(objects){
    ...
    setTimeout(function(){
        ...
        for (var i = 0; i < objects.length; i++) {
            ...
            var svgString = "<g id='svg_"+objects[i].id+"' transform='translate("+objects[i].x+","+objects[i].y+") rotate("+objects[i].rotation+" "+objects[i].width/2+","+objects[i].height/2+")' class='"+objectPrefix+"'>"+objects[i].svgString+""+textLabel+"</g>"
