...
var pathActions = canvas.pathActions = function() {
	...
	function resetD(p) { //uncommenting see this: https://code.google.com/p/svg-edit/issues/detail?id=1235
...
this.setSvgString = function(xmlString) {
	try {
		...
		//current_zoom = 1; nicholaswmin - commenting out/ why are we resetting the zoom lvl here - it messes up the UX when importing svg's
